...
e1 = Employee.create(name: "Don Munga", wage_rate: 52, labor_union: "Laborer")
e2 = Employee.create(name: "Scar Mkadinali", wage_rate: 60, labor_union: "Laborer")
e3 = Employee.create(name: "Sewer Syda", wage_rate: 46, labor_union: "Carpenter")
e4 = Employee.create(name: "Abbas Dobeez", wage_rate: 46, labor_union: "Carpenter")
e5 = Employee.create(name: "Kitu Sewer", wage_rate: 72, labor_union: "Operator")
m1 = Employee.create(name: "G Wiji", wage_rate: 100, labor_union: "Supervision")
